        ...
        {events.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-100">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Commencez par créer votre premier Secret Santa !
            </p>
            <div className="mt-6">
              <Link
                href="/secretsanta/create"
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {events.map((event) => (
              <div
                key={event.id}
                className="bg-white overflow-hidden rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-100 h-full flex flex-col"
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex-1">
                    <Link href={`/events/${event.id}`}>
                      <h3
                        className="text-lg font-semibold text-gray-900 mb-2 truncate hover:text-red-600 cursor-pointer"
                        title={event.title}
                      >
                        {event.title}
                      </h3>
