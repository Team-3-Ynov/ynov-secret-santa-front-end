...
export default function ProfilePage() {
    ...
    const handleSave = async () => {
        ...
        if (!trimmedUsername) {
            setError('Le nom d\'utilisateur est obligatoire et ne peut pas être vide.');
            return;
        }
                                ...
                                {isEditing && (
                                    <div className="pt-4 flex gap-3">
                                        ...
                                        <button
                                            onClick={handleEditToggle}
                                            disabled={isSaving}
                                            className="flex-1 inline-flex justify-center items-center px-4 py-2.5 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            Annuler
                                        </button>
                                    </div>
